...
```{r filter, message=FALSE, title="{{ site.worksheet }}"}
library(dplyr)
...
```{r arrange, title="{{ site.worksheet }}"}
...
```{r summarize, title="{{ site.worksheet }}"}
